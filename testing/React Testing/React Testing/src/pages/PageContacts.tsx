...
import imgPfpWebsite from '../assets/DiscordLogo.svg';
...
import imgIconWebsite from '../assets/DiscordLogo.svg';
                ...
                {/* Content */}
                    <div className={styles.content}>
                        ...
                        {/* Links */}
                            ...
                            {/* Website */}
                            <a href="https://www.featherforge.net" target="_blank" rel="noopener noreferrer" className={styles.linkBody}>
                                <div className={styles.linkContent}>
                                    <img className={styles.linkPfp} src={imgPfpWebsite} alt="Profile"/>

                                    <div className={styles.linkTextContainer}>
                                        <h2 className={styles.linkHeading}>Website</h2>
                                        <p className={styles.linkText}>featherforge.net</p>
                                    </div>

                                    <img className={styles.linkIcon} src={imgIconWebsite} alt="Link Icon"/>
                                </div>
                            </a>
